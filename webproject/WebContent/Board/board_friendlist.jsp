	...
	<table border="0" width="100%" cellpadding="4" cellspacing="0">
		...
		<%
			for (int i = 0; i < friendlist.size(); i++) {
				BoardBean board = (BoardBean) friendlist.get(i);
		%>
		<tr height="25" align="left">

			<td align="left"><%=board.getIdx()%>
			<td align="left"><a
				href="/webproject/main.jsp?mode=mypage&idx=<%=board.getIdx()%> ">
		...
		<table>
			<tr>
				...
				<td colspan="2"><input type="hidden" name="mode"
					value="myboard_search"> <input type="submit" name="search"
					value="검색">
			</tr>
		</table>
	</form>
